...
require_text ".github/workflows/progpu-wpf-sdk.yml" "PROGPU_WPF_PROGPU_PACKAGE_VERSION: 0.1.0-preview.39"
...
require_text ".github/workflows/progpu-wpf-release.yml" "default: 0.1.0-preview.35"
require_text ".github/workflows/progpu-wpf-release.yml" "default: 0.1.0-preview.39"
