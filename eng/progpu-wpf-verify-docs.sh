...
require_text ".github/workflows/progpu-wpf-sdk.yml" "PROGPU_WPF_PROGPU_PACKAGE_VERSION: 0.1.0-preview.44"
...
require_text ".github/workflows/progpu-wpf-release.yml" "default: 0.1.0-preview.38"
require_text ".github/workflows/progpu-wpf-release.yml" "default: 0.1.0-preview.44"
