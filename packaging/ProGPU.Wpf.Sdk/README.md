...
The quickcheck expects the local `0.1.0-preview.35` LibreWPF package feed and its ProGPU `0.1.0-preview.37` runtime dependencies to be current. Use the full SDK CI gate when package contents need to be rebuilt from source:
