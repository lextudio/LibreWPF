...
The quickcheck expects the local `0.1.0-preview.17` package feed to be current. Use the full SDK CI gate when package contents need to be rebuilt from source:
