...
- Built `ProGPU.Wpf.Tests` and ran `WpfManagedProjectGraphTests`; 24 focused graph tests passed, covering the real `PresentationFramework` harness, the real XAML compiler harness, and native-entrypoint guard coverage.
