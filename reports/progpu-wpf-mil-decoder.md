...
Video and effect scopes are counted as unsupported at the WPF replay layer. Effect execution should lower to ProGPU-native descriptors such as `WpfShaderEffect` rather than managed CPU pixel loops. Non-axis-aligned guideline snapping and exact WPF guideline semantics remain pending; supported guideline records now snap basic primitive coordinates while preserving render-data stack balance. Drawing resources that cannot be adapted are skipped rather than silently rendered incorrectly.
