...
- Geometry: move remaining WPF fidelity gaps into ProGPU vector code, including exact Bezier dash spans, exact boolean-result dashed outlines, non-axis-aligned guideline snapping policy, and robust cap clipping at complex joins.
