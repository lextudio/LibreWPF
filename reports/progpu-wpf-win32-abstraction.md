...
2. Complete portable window lifecycle integration beyond the first `Window.Show`, `Hide`, `WindowState`, and `Application.Run` bridge: close-cancellation semantics, activation/focus behavior, app shutdown edge cases, and host disposal ordering.
