...
- Dispatcher posting: `QueuedWpfDispatcherService` queues callbacks by WPF-shaped priority and processes them on the owning thread from `ProGpuWpfWindowHost.ProcessDispatcherQueue`, `DoEvents`, and render callbacks.
