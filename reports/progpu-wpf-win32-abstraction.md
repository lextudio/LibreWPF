...
2. Complete portable window lifecycle integration beyond the first `Window.Show`, `Hide`, `WindowState`, `Closing` cancellation, and `Application.Run` bridge: activation/focus behavior, app shutdown edge cases, and host disposal ordering.
