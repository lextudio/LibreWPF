...
3. Complete remaining popup runtime validation.
   - Covered now: main menu, real AddInTree context menu, ComboBox, Core.Presentation toolbar drop-down button, hosted WinForms `ContextMenuStrip`, and AvalonEdit completion popup through package-mode SharpDevelop flows.
   - Remaining: validate AvalonDock tab/dropdown/flyout popup interactions and manual user-driven menu/context-menu flows beyond the in-process smoke harness.
