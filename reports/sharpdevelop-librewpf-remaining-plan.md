...
5. Broaden workbench service/runtime coverage.
   ...
   - Remaining: exercise debug commands, templates, add-in loading, command routing, broader workbench pads, toolbar updates, editor navigation, additional project loading cases, modal save-as dialog routing, external-change prompt paths for dirty files, and shutdown persistence.
