...
2. Finish AvalonDock floating/flyout parity.
   ...
   - Covered now: live full-shell smoke for `ProjectBrowserPad` dockable floating window creation, redock, auto-hide, flyout creation, and final dock restore.
...
3. Complete remaining popup runtime validation.
   - Covered now: main menu, real AddInTree context menu, ComboBox, Core.Presentation toolbar drop-down button, hosted WinForms `ContextMenuStrip`, AvalonEdit completion popup, and AvalonDock auto-hide flyout through package-mode SharpDevelop flows.
