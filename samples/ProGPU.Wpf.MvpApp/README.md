...
- WPF app resources, menus, bindings, routed commands, input bindings, `CollectionViewSource` sorting/grouping/filtering, resource `DataTemplate`s, compiled `ControlTemplate` styles, reusable `UserControl`, `Frame`/`Page` navigation, list/table/tree controls, and a basic `FlowDocument`
