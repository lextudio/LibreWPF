...
- WPF app resources, menus, bindings, routed commands, input bindings, resource `DataTemplate`s, reusable `UserControl`, `Frame`/`Page` navigation, list/table/tree controls, and a basic `FlowDocument`
