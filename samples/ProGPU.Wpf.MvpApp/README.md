...
- WPF app resources, menus, bindings, routed commands, input bindings, item templates, reusable `UserControl`, `Frame`/`Page` navigation, list/table/tree controls, and a basic `FlowDocument`
