...
Run the same app through a bounded `Application.Run()` validation that opens via `StartupUri`, validates the WPF object graph, application manager state, startup event resources, and shuts down automatically:
