...
public partial class MainWindow : Window
{
    ...
    private void AttachRealSciChartPackageSurface()
    {
        ...
        {
            BackendText.Text = $"Real SciChart native runtime unavailable: {_realSciChartResult.NativeCompatibilitySummary}; resolver: {_realSciChartResult.NativeResolverSummary}";
        }
    }
