...
The 3D panel exercises native surface-mesh, point-cloud, line-strip, XYZ-data-series ribbon, and triangle-strip draw paths so future SciChart3D axes, grids, and line-series adapters can land in `ProGPU.DirectX` instead of managed WPF bitmap fallbacks.
