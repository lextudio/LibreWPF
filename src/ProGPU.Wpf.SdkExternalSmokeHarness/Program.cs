...
internal static class Program
{
    ...
    private const string SdkVersion = "0.1.0-preview.34";
    private const string ProGpuPackageVersion = "0.1.0-preview.30";
    ...
    private static void ValidateSdkPackageLayout(string packageFeed)
    {
        ...
        AssertContains(sdkProps, "<ProGpuWpfSdkVersion Condition=\"'$(ProGpuWpfSdkVersion)' == ''\">0.1.0-preview.34</ProGpuWpfSdkVersion>", "SDK root version default");
