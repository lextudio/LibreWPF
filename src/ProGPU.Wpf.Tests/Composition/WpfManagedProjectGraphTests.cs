...
public sealed class WpfManagedProjectGraphTests
{
    ...
    public void RealPresentationFrameworkSmokeGuardsNativePlatformEntrypoints()
    {
        ...
        AssertGuardBefore(popup, "if (!OperatingSystem.IsWindows())\n                {\n                    _window = new PortablePresentationSource();", "HwndSource newWindow = new HwndSource(param)");
        ...
        AssertGuardBefore(popup, "if (!OperatingSystem.IsWindows())\n                {\n                    return;\n                }\n\n                if (IsChildPopup)", "UnsafeNativeMethods.ShowWindow");
    ...
    public void ProGpuWpfSdkProvidesSwitchOnlyPackagingSurface()
    {
        ...
        var textEditorCopyPastePath = FindRepoPath(
            "src",
            "Microsoft.DotNet.Wpf",
            "src",
            "PresentationFramework",
        ...
        Assert.Contains("Microsoft.Win32.PortableFileDialogService", mvpMainWindowCodeBehind, StringComparison.Ordinal);
        Assert.Contains("RegisterDeterministicFileDialog", mvpMainWindowCodeBehind, StringComparison.Ordinal);
        ...
        Assert.Contains("action tooltip opened through portable popup", runtimeHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("action tooltip closed through portable popup", runtimeHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("ExternalArrayItemsControl", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("external SDK x:Array ItemsSource", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("ValidateRuntimeResourceReference(window)", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("SetResourceReference(TextBlock.ForegroundProperty, \"ExternalDynamicBrush\")", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("external SDK runtime SetResourceReference updated foreground", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("MainWindow : Window, INotifyPropertyChanged, IDataErrorInfo, INotifyDataErrorInfo", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("x:Name=\"ExternalNotifyDataErrorValidationTextBox\"", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("NotifyDataErrorText, Mode=TwoWay, UpdateSourceTrigger=Explicit, ValidatesOnNotifyDataErrors=True, NotifyOnValidationError=True", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("public string NotifyDataErrorText", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("public event EventHandler<DataErrorsChangedEventArgs>? ErrorsChanged", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("External INotifyDataErrorInfo requires notify: prefix.", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("external SDK INotifyDataErrorInfo binding ValidatesOnNotifyDataErrors", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("external SDK INotifyDataErrorInfo validation error content", externalSdkHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("external SDK INotifyDataErrorInfo validation recovered source", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("GetRequiredType(windowsBase, \"System.Windows.Rect\")", externalSdkHarnessProgram, StringComparison.Ordinal);
        ...
        Assert.Contains("GetRequiredType(presentationCore, \"System.Windows.Media.SolidColorBrush\")", runtimeHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("GetRequiredType(windowsBase, \"System.Windows.Rect\")", runtimeHarnessProgram, StringComparison.Ordinal);
        Assert.Contains("CreateRedWpfVisual(presentationCore, presentationFramework, windowsBase)", runtimeHarnessProgram, StringComparison.Ordinal);
